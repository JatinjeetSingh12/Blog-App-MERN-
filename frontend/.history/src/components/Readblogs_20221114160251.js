...
const Readblogs = () => {
    ...
    return (
        <>
            ...
            <button type="button" ref={} className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                Launch demo modal
            </button>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" name='eurl' id="eurl" onChange={onchange} />
                            </div>
                        </div>
