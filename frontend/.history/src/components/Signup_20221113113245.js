...
const Signup = () => {
    ...
    const handleSignup = (e) => {
        e.preventDefault();
        CreateUser(credintials.name, credintials.email, credintials.password);
    }
            ...
            <div className="container my-4">
                ...
                <form onSubmit={handleSignup}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="email" className="form-control" id="exampleInputEmail1" name='' onChange={onchange} aria-describedby="emailHelp" minLength={5} required />
                    </div>
                    <div className="mb-3">
