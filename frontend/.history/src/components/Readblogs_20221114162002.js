                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="mb-3">
                                ...
                                <input type="text" value={etitle} className="form-control" name='etitle' id="etitle"  onChange={onchange} />
                            </div>
                            <div className="mb-3">
                                <label forhtml="edescription" className="form-label">Description</label>
                                <input type="text" value={edescription} className="form-control" name='edescription' id="edescription" onChange={onchange} />
                            </div>
                            <div className="mb-3">
                                <label forhtml="eimage" className="form-label">image</label>
                                <input type="text"value={cfeimage} className="form-control" name='eimage' id="eimage" onChange={onchange} />
                            </div>
                        </div>
